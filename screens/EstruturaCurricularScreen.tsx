        ...
        ListFooterComponent={() => (
          <View style={styles.footer}>
            ...
            <TouchableOpacity
              ...
              onPress={() =>
                Linking.openURL(
                  'https://portal.uern.br/dsib/manual-de-trabalhos-academicos/'
                )
              }
            >
              <Text style={styles.buttonText}>Clique Aqui!</Text>
            ...
            {isCartilhaOpen && (
              <View style={styles.accordionContent}>
                ...
                <TouchableOpacity
                  ...
                  onPress={() =>
                    Linking.openURL(
                      'https://drive.google.com/file/d/1b6z9bcqoeQ3JhY0_neQwosSsxJ6XCokM/view'
                    )
                  }
                >
                  <Text style={styles.buttonText}>Clique Aqui!</Text>
            ...
            {isCurricularSimplificadaOpen && (
              <View style={styles.accordionContent}>
                ...
                <TouchableOpacity
                  ...
                  onPress={() =>
                    Linking.openURL(
                      'https://drive.google.com/file/d/1ETSAV4qA54u6EKspmlEkMMO-9v-6CAtD/view'
                    )
                  }
                >
                  <Text style={styles.buttonText}>Clique Aqui!</Text>
